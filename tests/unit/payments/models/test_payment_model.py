...
@pytest.mark.django_db
def test_payment_str_method(payment_data):
    """
    Tests if the __str__ method returns the Model name with the respective object id.
    """
    # Arrange
    payment = payment_data["payment"]
    ...
    # Assert
    assert result == f'{Payment.__name__} {payment.pk}'
