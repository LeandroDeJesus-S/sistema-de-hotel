...
class TestScheduleReservationUseCase:
    @pytest.fixture
    def use_case(self, mock_reservation_repo, mock_unit_of_work, mock_task_queuer, mock_logger):
    ...
    def test_success(self, use_case, mock_reservation_repo, mock_task_queuer, client_entity, room_entity):
