...
class TestActivateReservationUseCase:
    ...
    def test_success(self, use_case, mock_reservation_repo, mock_room_repo, reservation_model_instance_factory, client_entity, room_entity):
    ...
    def test_reservation_save_failure(self, use_case, mock_room_repo, mock_reservation_repo, client_entity, room_entity):
