...
class TestReleaseReservationUseCase:
    @pytest.fixture
    def use_case(self, mock_room_repo, mock_reservation_repo, mock_payments_repo, mock_unit_of_work, mock_logger):
    ...
    def test_success(self, use_case, mock_reservation_repo, mock_room_repo, client_entity, room_entity):
    ...
    def test_reservation_save_failure(self, use_case, mock_reservation_repo, client_entity, room_entity):
        from datetime import date, timedelta
        from decimal import Decimal
        res = Reservation.safe_create(
            id=1,
    ...
    def test_room_save_failure(self, use_case, mock_reservation_repo, mock_room_repo, client_entity, room_entity):
        from datetime import date, timedelta
        from decimal import Decimal
        res = Reservation.safe_create(
            id=1,
