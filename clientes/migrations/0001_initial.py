# Generated by Django 3.2.25 on 2024-07-22 21:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(max_length=25, validators=[django.core.validators.RegexValidator('[A-Za-z]{2,25}', 'O nome deve conter apenas letras'), django.core.validators.MaxLengthValidator(25, 'Nome muito grande.'), django.core.validators.MaxLengthValidator(2, 'Nome muito pequeno.')], verbose_name='Nome')),
                ('sobrenome', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator('[A-Za-z]{2,50}', 'O sobrenome deve conter apenas letras'), django.core.validators.MinLengthValidator(2, 'Sobrenome muito pequeno.'), django.core.validators.MinLengthValidator(50, 'Sobrenome muito grande.')], verbose_name='Sobrenome')),
