...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='client',
            name='cpf',
            field=models.CharField(error_messages={'unique': 'CPF não disponível.'}, max_length=11, unique=True, validators=[clients.infra.validators.CpfValidator(message='CPF inválido.', raise_exc=True).validate], verbose_name='CPF'),
        ),
        migrations.AlterField(
            model_name='client',
            name='email',
        ...
        migrations.AlterField(
            model_name='client',
            name='phone',
            field=models.CharField(error_messages={'blank': 'Telefone não pode ser vazio.', 'invalid': 'Número de telefone inválido.', 'null': 'Telefone não pode ser vazio.', 'unique': 'Telefone não disponível.'}, max_length=11, unique=True, validators=[clients.infra.validators.PhoneNumberValidator(raise_exc=True, weak=settings.DEBUG).validate], verbose_name='Telefone'),
        ),
        migrations.AlterField(
            model_name='client',
            name='username',
